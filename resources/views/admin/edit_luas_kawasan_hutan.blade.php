...
@section('page_title', 'Ubah Luas Kawasan Hutan')
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs paitent-app-tab">
                        <li><a href="/admin/kawasan/hutan">Kembali</a></li>
                        <li class="active"><a href="#edit-target" data-toggle="tab">Ubah Luasan</a></li>
                    </ul>
                    <div class="tab-content" style="padding-top: 10px;">
                        <div class="tab-pane active" id="edit-target">
                            <form class="page-box" method="post" action="/admin/kawasan/hutan/{{ $data->id }}/{{ $data->tahun }}">
                                @csrf
                                @method('put')
