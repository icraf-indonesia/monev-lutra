...
@section('page_title', 'Luas Kawasan Hutan')
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="nav nav-tabs paitent-app-tab">
                        ...
                        <li class="active"><a href="{{url('')}}/admin/kawasan/hutan">Luas Kawasan Hutan</a></li>
                    </ul>
                    <div class="tab-content" style="padding-top: 10px;">
                        <div class="row">
                            ...
                            <div class="col-lg-3" style="margin-top: 10px">
                                <a class="custom-badge bg-primary status-blue text-right" href="/admin/kawasan/hutan/tambah/{{$selectedPeriode}}" style="padding: 10px">Tambah Kecamatan</a>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($luas as $l)
                                            <tr>
                                                ...
                                                <td width="5%">
                                                    <a class="custom-badge status-green bg-success text-right" href="/admin/kawasan/hutan/{{ $l->id }}">Ubah</a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
