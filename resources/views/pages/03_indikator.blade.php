        ...
        <div class="table-responsive">
          <table id="tabel-data" class="table table-bordered table-striped" style="width:100%; border:0; font-size:12;">
            ...
            <tr>
              ...
              <td width="10%" data-bs-toggle="modal" data-bs-target="#addnew3">{{ $table->terpercaya}}</td>
              <td width="10%" data-bs-toggle="modal" data-bs-target="#addnew4">{{ $table->landscale}}</td>
              <td width="10%" data-bs-toggle="modal" data-bs-target="#addnew5">{{ $table->sourceup}}</td>
