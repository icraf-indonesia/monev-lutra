...
<div class="row">
    <div class="column">
      <div class="card">
        <h6><b>Apa itu Monev Luwu Utara?</b></h6>
    ...
    <div class="column">
      <div class="card">
        <h6><b>Manfaat Monev Luwu Utara</b></h6>
    ...
    <div class="column">
      <div class="card">
        <h6><b>Pendekatan Monitoring dan Evaluasi</b></h6>
        <img src="dist/img/10.jpg" alt="" style="padding-bottom: 20px;">
        <p>Monitoring dan evaluasi peta jalan kakao lestari Kabupaten Luwu Utara dibangun menggunakan pendekatan jurisdiksi. Jurisdiksi adalah unit politik baik di itngkat nasional maupun sub-nasional. Pada kasus ini jurisdiksi yang dimaksud adalah tingkat kabupaten. Pendekatan pengelolaan komoditas berdasarkan jurisdiksi merupakan perpaduan antara pendekatan perencanaan wilayah (dimana pemerintah menentukan area lindung dan budidaya (go or no-go area) dan pendekatn sertifikasi komoditas berkelanjutan. Deskripsi pendekatan jurisdiksi:</p>
        ...
        <p>4. Ada insenntif bagi produsen utunk memetuhi aturan secara kolektif</p>
      </div>
    </div>
    <div class="column">
      <div class="card">
