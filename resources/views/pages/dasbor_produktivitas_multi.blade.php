...
@section('page_title', 'Strategi 3 (Capaian Multi-tahun)')
            ...
            <div class="col-md-12 patient-app-01">
                <table id="patientfilter" class="table table-striped dt-responsive nowrap" cellspacing="0"
                    ...
                    <thead>
                        <tr>
                            <th>Tahun</th>
                            <th>Budidaya kakao dengan penerapan GAP</th>
                            <th>Akses terhadap sarana dan prasarana pendukung usaha tani kakao</th>
                            <th>Diversifikasi produk kakao</th>
                            <th>Agribisnis kakao</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($produktivitas_multi as $item)
                            <tr>
                                <td>{{ $item->tahun }}</td>
                                <td>
                                    @if (is_null($item->i01))
