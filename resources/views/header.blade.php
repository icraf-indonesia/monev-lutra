                ...
                <div class="row">
                    <div class="col-md-8 col-sm-12 header-navbar-lft text-center" style="padding-left: 0px;">
                        <a class="web-logo1 visible-xs visible-sm" href="{{ url('') }}/"><img
                                src="{{ url('') }}/dist/assets/img/header-kab-small.png" class="img-responsive"
                                alt=""></a>
                        ...
                        <ul id="menu" class="hidden-xs hidden-sm" style="padding-right:0px; padding-left:0px;">
                            <li><a class="web-logo" href="{{ url('') }}/"><img
                                        src="{{ url('') }}/dist/assets/img/header-kab-small.png"
                            ...
                            <li><a class="prett">Peta Jalan</a>
                                <ul class="menus">
                                    ...
                                    <li><a href="{{ url('') }}/strategi_intervensi">Visi, Strategi dan
                                            Intervensi</a></li>
                                </ul>
                            </li>
                    ...
                    <div id="slide-navbar-collapse" class="collapse mobile-sidemenu">
                        <ul>
                            ...
                            <li><a class="home" href="{{ url('') }}/indikator">Indikator</a></li>
                            <li><a class="home" href="{{ url('') }}/gambaran_umum_tahunan">Profil
                                    Jurisdiksi</a></li>
